...
export default function FormIcon() {
  ...
  return (
    <>
      {click && (
        <div className="col-11 col-sm-8 col-lg-3 bg-white rounded-3 overflow-hidden floatingForm">
          <h4 className="bg-primary text-white p-1 px-sm-4 d-flex justify-content-around py-3">
            Register As Agent
            <i
              className="bi bi-x"
